...
public final class DateUtil {
    ...
    public static long parseDateDiff(final String time, final boolean future, final boolean emptyEpoch) throws Exception {
    ...
    public static String formatDate(final long date, final Essentials ess) {
