...
import net.essentialsx.fabric.command.InvalidModifierException;
...
public final class NumberUtil {
    ...
    private static final Locale PRETTY_LOCALE = Locale.US;
    ...
    public static String shortCurrency(final BigDecimal value, final Essentials ess) {
    ...
    public static String displayCurrency(final BigDecimal value, final Essentials ess) {
        return displayCurrency(value, ess, false);
    }

    public static String displayCurrencyExactly(final BigDecimal value, final Essentials ess) {
        return displayCurrency(value, ess, true);
    }

    private static String displayCurrency(final BigDecimal value, final Essentials ess, final boolean exact) {
    ...
    public static String sanitizeCurrencyString(final String input, final Essentials ess) {
